...
Using one that is too large instead, might overshoot the targeted minima when stepping, e.g. $A$ on \autoref{fig:descent-global} might end up falling on $M_1$ instead of $M_2$.

% TODO: \subsubsection{Minima}
